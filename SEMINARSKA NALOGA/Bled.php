  ...
  <body>
    ...
    <nav class="navbar">
      <div class="navbar__container">
        <a href="index.html" id="navbar__logo"><img src="slike/logo_bel.png" id="navbar__logo" alt="Erik Jerman Photography"></img></a>
      ...
      <div class="main__container">
        ...
        <h1><?php echo $ime_izdelka; ?></h1>
          ...
          <form action="dodaj_v_kosarico.php" method="post">
                <input type="hidden" name="id_izdelka" value="12">
